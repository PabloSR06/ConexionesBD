...
CREATE TABLE habitaciones(
    ...
    CONSTRAINT PK_codHotelHabitacion PRIMARY KEY (codHotel, numHabitacion),
...
CREATE TABLE estancias(
    ...
    codHotel CHAR(6) NOT NULL, 
    numHabitacion VARCHAR(4) NOT NULL,
    CONSTRAINT FK_HABITACIONES FOREIGN KEY (codHotel, numHabitacion) REFERENCES habitaciones(codHotel, numHabitacion),
